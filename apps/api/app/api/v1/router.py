...
from app.api.v1 import admin, auth, feedback, kpis, notifications, onboarding, profile, recognitions, reviews, rewards, surveys, voe
...
api_router.include_router(voe.router, prefix="/voe", tags=["voice-of-employee"])
