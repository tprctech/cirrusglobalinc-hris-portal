...
function nextTemplateFormId() {
  ...
  return `review-template-form-${templateFormCounter}`;
}

function nextQsFormId() {
  qsFormCounter += 1;
  return `review-question-set-form-${qsFormCounter}`;
}
  ...
  return (
    <section className="admin-center-page">
      <div className="admin-center-shell">
        ...
        <div className="admin-center-content">
          ...
          <section className="admin-users-section">
            <div className="admin-users-toolbar">
              <div><h2>Review Templates</h2></div>
          ...
          <section className="admin-users-section">
            <div className="admin-users-toolbar">
              <div><h2>Review Question Sets</h2></div>
      ...
      <TemplateBuilderModal
        ...
        modalTitle={editingQsId ? 'Edit Review Question Set' : 'Create Review Question Set'}
