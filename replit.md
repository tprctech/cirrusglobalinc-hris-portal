...
- `apps/api/app/db/models.py` - All SQLAlchemy ORM models (34 tables)
...
- `/api/v1/notifications` - GET (user's notifications), PUT `/{id}/read` (mark one read), PUT `/read-all` (mark all read)
